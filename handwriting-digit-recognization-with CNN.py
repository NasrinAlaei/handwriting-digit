...
# %cd /content/drive/My Drive/CNN/project
!ls
...
# train dataset
X_train, Y_train = __read_hoda_dataset(dataset_path='/content/drive/My Drive/CNN/project/hoda/data/Train 60000.cdb',
                                images_height=32,
                                images_width=32,
                                one_hot=False ,
                                reshape=False)
# test dataset
X_test, Y_test = __read_hoda_dataset(dataset_path='/content/drive/My Drive/CNN/project/hoda/data/Test 20000.cdb',
                              images_height=32,
                              images_width=32,
                              one_hot=False,
                              reshape=False)
# remain dataset
X_remain, Y_remain = __read_hoda_dataset('/content/drive/My Drive/CNN/project/hoda/data/RemainingSamples.cdb',
                                             images_height=32,
                                             images_width=32,
                                             one_hot=False,
                                             reshape=False)
...
train_images, train_labels = __read_hoda_cdb('/content/drive/My Drive/CNN/project/hoda/data/Train 60000.cdb')

test_images, test_labels = __read_hoda_cdb('/content/drive/My Drive/CNN/project/hoda/data/Test 20000.cdb')

remaining_images, remaining_labels = __read_hoda_cdb('/content/drive/My Drive/CNN/project/hoda/data/RemainingSamples.cdb')
